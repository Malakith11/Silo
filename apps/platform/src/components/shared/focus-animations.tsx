...
export const FocusAnimation = forwardRef<HTMLDivElement, FocusAnimationProps>(function FocusAnimation(
  {
    children,
    className,
    type = "scale",
 ...
 *
 * @param props Props for the FocusCard component, excluding the "type".
 */
